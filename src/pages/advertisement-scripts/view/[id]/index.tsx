...
import { getAdvertisementScriptById } from 'apiSdk/advertisement-scripts';
...
function AdvertisementScriptViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Advertisement Script Detail View
          </Text>
          {hasAccess('advertisement_script', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/advertisement-scripts/edit/${data?.id}`} passHref legacyBehavior>
              <Button
